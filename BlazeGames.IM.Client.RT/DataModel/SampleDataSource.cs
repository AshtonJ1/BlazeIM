...
namespace BlazeGames.IM.Client.RT.Data
{
    /// <summary>
    ...
    public abstract class DataCommon : BlazeGames.IM.Client.RT.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            var OnlineContactsGroup = new DataGroup("Group-Contacts-Online",
                    "Online",
                    "Group Subtitle: 1",
                    "Assets/DarkGray.png",
                    "Group Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor scelerisque lorem in vehicula. Aliquam tincidunt, lacus ut sagittis tristique, turpis massa volutpat augue, eu rutrum ligula ante a ante");
            
            OnlineContactsGroup.Items.Add(new DataItem("Group-1-Item-1",
                    "Ashton Storks",
                    "CEO @ Blaze Games",
                    "https://blaze-games.com/api/image/nocompress/?nickname=Ashton%20Storks",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, OnlineContactsGroup));

            var BusyContactsGroup = new DataGroup("Group-Contacts-Busy",
                   "Busy",
                   "Group Subtitle: 1",
                   "Assets/DarkGray.png",
                   "Group Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor scelerisque lorem in vehicula. Aliquam tincidunt, lacus ut sagittis tristique, turpis massa volutpat augue, eu rutrum ligula ante a ante");

            var AwayContactsGroup = new DataGroup("Group-Contacts-Away",
                   "Away",
                   "Group Subtitle: 1",
                   "Assets/DarkGray.png",
                   "Group Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor scelerisque lorem in vehicula. Aliquam tincidunt, lacus ut sagittis tristique, turpis massa volutpat augue, eu rutrum ligula ante a ante");

            var OfflineContactsGroup = new DataGroup("Group-Contacts-Offline",
                   "Offline",
                   "Group Subtitle: 1",
                   "Assets/DarkGray.png",
                   "Group Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor scelerisque lorem in vehicula. Aliquam tincidunt, lacus ut sagittis tristique, turpis massa volutpat augue, eu rutrum ligula ante a ante");

            this.AllGroups.Add(OnlineContactsGroup);
            this.AllGroups.Add(BusyContactsGroup);
            this.AllGroups.Add(AwayContactsGroup);
            this.AllGroups.Add(OfflineContactsGroup);
        }
    }
}
